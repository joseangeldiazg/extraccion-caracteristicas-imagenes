...
public class TestBasico {
    ...
    public static void main(String[] args) {
        ...
        //En este caso pasamos de RGB a color
        Imgproc.cvtColor(image, gris, Imgproc.COLOR_RGB2GRAY);
        //En este caso emborronamos, imgproc tiene muchas funciones para cambiar colores y demás
        ...
        // 2. ------ Harris -> La salida de Harris es flotante por lo que si se quiere visualizar no deja
        //
        ...
        System.out.println("HOG ("+descriptors.size()+"): "+
                ...
                ", stride size: "+hog.get_blockStride()+ //Si el tamaño de la venta es mas pequeño que la imagen en su conjunto ira moviendo esa ventana
